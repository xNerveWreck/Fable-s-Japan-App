...
Run this audit in order, then report. The SessionStart hook has already installed
dependencies and built once, so everything below works from the first turn.
