...
| **v4.0.0** | 一緒に *Issho ni* | Together | **Family Ink (live sync)** — built on `claude/live-family-sync`, pending owner merge — realtime rows on Supabase, folded link stays as floor |
