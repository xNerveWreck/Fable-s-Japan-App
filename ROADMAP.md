...
| **v3** 🖌️ | 生きている *Ikiteiru* | The painting lives | **Shipped:** solar clock, microseasons, nijimi physics (plus field fixes: the iOS departure-date picker, day-to-day paging). **Remaining:** living vignettes, Sumi (mascot), opening cinematic, kids' game layer (yōkai camera, Denshadex, boss battles, side quests), geofenced stamps, Fuji Window |
