...
|---|---|---|---|
| **v2.1** | 記憶 *Kioku* | Remember | The committed four: journal + photos, sound & haptics, four travelers, the Japan clock |
| **v3** | 生きている *Ikiteiru* | The painting lives | Solar clock, microseasons, living vignettes, nijimi physics, Sumi (mascot), opening cinematic, kids' game layer (yōkai camera, Denshadex, boss battles, side quests), geofenced stamps, Fuji Window |
