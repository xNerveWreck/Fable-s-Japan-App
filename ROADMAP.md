...
| **v3** 🖌️ | 生きている *Ikiteiru* | The painting lives | **Shipped:** solar clock, microseasons, nijimi physics, living vignettes (tilt/drift depth planes, the heron, the gondola, the deer's bow, after-dark neon and windows) (plus field fixes: the iOS departure-date picker, day-to-day paging, Windows story-suite spawn). **Remaining:** Sumi (mascot), opening cinematic, kids' game layer (yōkai camera, Denshadex, boss battles, side quests), geofenced stamps, Fuji Window |
